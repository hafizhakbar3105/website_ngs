    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->update_type == 'main') {
            $request->validate([
                ...
                'brochure'         => 'nullable|file|mimes:pdf,doc,docx,jpg,jpeg,png|max:10240', // Brosur dinaikkan ke 10 MB
                'gallery.*'        => 'nullable|image|mimes:jpeg,png,jpg,webp|max:10240',      // Galeri dinaikkan ke 10 MB
            ]);
